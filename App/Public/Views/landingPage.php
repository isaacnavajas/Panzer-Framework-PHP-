...
<body>
    <div class="content">
        <center>
            <img src="./App/Public/Src/panzer.jpg" alt="qultep" id="qultep">
            <h1 class="fontBear">Panzer</h1>
            <p>
                Saludos, soy Isaac Navajas Pozo y estoy desarrollando Qulteep, un framework diseñado para ofrecerte una experiencia intuitiva y escalable en el desarrollo de proyectos. Con Qultep, podrás disfrutar de una plataforma fácil de usar que se adapta a cualquier tipo de proyecto. ¡Espero que te entusiasme tanto como a mí!
            </p>
